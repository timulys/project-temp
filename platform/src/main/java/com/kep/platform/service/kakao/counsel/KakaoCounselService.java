...
public class KakaoCounselService {
    ...
    private static final java.util.regex.Pattern kakaoImageUploadPattern = java.util.regex.Pattern.compile("kakao.com");
    private static final java.util.regex.Pattern kakaoFileUploadPattern = java.util.regex.Pattern.compile("kakao.com");
