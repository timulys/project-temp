...
public class IssuePayload {
	 ...
	 * off : 상담원 연결이 지연되고 있습니다. 잠시 후 다시 이용해 주세요.(훌쩍)
	 * no_operator : 지금은 상담 가능 시간이 아닙니다.(깜짝)
	 * no_answer : 일정 시간 동안 고객님의 응답이 없어 채팅을 종료합니다.(우와)
	 * wait : 상담원 연결 대기 중입니다. 잠시만 기다려 주세요.(제발)
	 */
