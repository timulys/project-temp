 ...
 *
 */
@Schema(description = "템플릿 목록 조회 V1 응답 VO (contents 내부를 제외하곤 카멜 케이스)")
@Data
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = false)
public class KakaoGetTemplateResponseV1 implements GiftExternalResponse {
    ...
    @Schema(name = "GetTemplateResponseV1.Content", description = "템플릿 정보")
    @Data
    @NoArgsConstructor
    @AllArgsConstructor
    @EqualsAndHashCode(callSuper = false)
    ...
    public static class Content {
        ...
        @Schema(name = "GetTemplateResponseV1.Product", description = "상품 정보 (템플릿 목록 조회 v1)")
        @Data
        @NoArgsConstructor
        @AllArgsConstructor
        @EqualsAndHashCode(callSuper = false)
