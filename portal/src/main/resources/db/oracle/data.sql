...
-- 브랜치 상담 시간 (Static)
-- ////////////////////////////////////////////////////////////////////////////
INSERT INTO branch_off_duty_hours (ID, CREATED, CREATOR, DAY_OF_WEEK, END_COUNSEL_TIME, MODIFIED, MODIFIER, START_COUNSEL_TIME, BRANCH_ID)
...
VALUES (1, 'Y', '{
  ...
  "chapters" : [ {
    "sections" : [ {
      "type" : "text",
      "data" : "현재는 상담직원 응대가 어렵습니다. 근무시간에 다시 문의해주세요."
    } ]
  } ]
}');
...
INSERT INTO menu (ID, DEPTH, DISABLED_LEVELS, DISPLAY, ENABLED, LINK, MASTER_ENABLED, NAME1, NAME2, NAME3, NAME4, ROLE_ENABLED, SORT, TOP_ID)
VALUES (123, 3, null, null, 'Y', null, 'N', '상담포털', '고객목록', '선물하기', null, 'N', 123, 100);
INSERT INTO menu (ID, DEPTH, DISABLED_LEVELS, DISPLAY, ENABLED, LINK, MASTER_ENABLED, NAME1, NAME2, NAME3, NAME4, ROLE_ENABLED, SORT, TOP_ID)
