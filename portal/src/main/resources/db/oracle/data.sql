...
VALUES (1, 'branch', SYSDATE, 1, 'Y', 'member', 'Y', 50, 'batch', 100, SYSDATE, 1, '본사', 'Y', 'on', 0);

-- ////////////////////////////////////////////////////////////////////////////
-- 채널 (Static)
-- ////////////////////////////////////////////////////////////////////////////
INSERT INTO CHANNEL (ID, BRANCH_ID, MODIFIED, MODIFIER, NAME, PLATFORM, SERVICE_ID, SERVICE_KEY)
VALUES (1, 1, SYSDATE, 1, '기본 채널', 'kakao_counsel_talk', '@ntg2vdu2mtfllux', '8a598afbec5daa59702cc5b45e409213acd81810');

-- ////////////////////////////////////////////////////////////////////////////
-- 브랜치 - 채널 매칭 (Static)
-- ////////////////////////////////////////////////////////////////////////////
INSERT INTO BRANCH_CHANNEL (ID, CREATED, CREATOR, OWNED, BRANCH_ID, CHANNEL_ID)
VALUES (1, SYSDATE, 1, 'Y', 1, 1);
...
VALUES (1, SYSDATE, 1, 'MON,TUE,WED,THUR,FRI', '23:0', SYSDATE, 1, '8:0', 1);
...
VALUES (1, 1, 'Y', 'Y', 60, 'Y', 'all', 'Y', SYSDATE, 1, 'N');

-- ////////////////////////////////////////////////////////////////////////////
-- 상담 그룹 (Static)
-- ////////////////////////////////////////////////////////////////////////////
INSERT INTO TEAM (ID, CREATED, CREATOR, MEMBER_COUNT, MODIFIED, MODIFIER, NAME)
VALUES (1, SYSDATE, 1, 0, SYSDATE, 30, '기본 상담 그룹');
...
VALUES (9000000001, 1, SYSDATE, 1, 'N', null, 'N', 0, SYSDATE, 1, '시스템', '{bcrypt}$2a$10$WMhur0a3BIrHefd3w7Xlge2WowQDIr71WRtBXYOZ/7P/gLu1lKvim', null, null, 'off', 'system');
INSERT INTO MEMBER (ID, BRANCH_ID, CREATED, CREATOR, ENABLED, FIRST_MESSAGE, MANAGED, MAX_COUNSEL, MODIFIED, MODIFIER, NICKNAME, PASSWORD, PROFILE, SETTING, STATUS, USERNAME)
VALUES (9000000002, 1, SYSDATE, 1, 'N', null, 'N', 0, SYSDATE, 1, '오픈빌더', '{bcrypt}$2a$10$ddRQcGFDi/Ng0pwztKnTS.4vnTg1df1o4MNeWLWfBIAKh.ZZRpmR2', null, null, 'off', 'openbuilder');
INSERT INTO MEMBER (ID, BRANCH_ID, CREATED, CREATOR, ENABLED, FIRST_MESSAGE, MANAGED, MAX_COUNSEL, MODIFIED, MODIFIER, NICKNAME, PASSWORD, PROFILE, SETTING, STATUS, USERNAME)
VALUES (1, 1, SYSDATE, 1, 'Y', null, 'N', 0, SYSDATE, 1, '마스터1', '{noop}master1', null, null, 'off', 'master1');
INSERT INTO MEMBER (ID, BRANCH_ID, CREATED, CREATOR, ENABLED, FIRST_MESSAGE, MANAGED, MAX_COUNSEL, MODIFIED, MODIFIER, NICKNAME, PASSWORD, PROFILE, SETTING, STATUS, USERNAME)
VALUES (2, 1, SYSDATE, 1, 'Y', null, 'Y', 0, SYSDATE, 1, '관리자1', '{noop}admin1', null, null, 'off', 'admin1');
INSERT INTO MEMBER (ID, BRANCH_ID, CREATED, CREATOR, ENABLED, FIRST_MESSAGE, MANAGED, MAX_COUNSEL, MODIFIED, MODIFIER, NICKNAME, PASSWORD, PROFILE, SETTING, STATUS, USERNAME)
VALUES (3, 1, SYSDATE, 1, 'Y', null, 'Y', 0, SYSDATE, 1, '매니저1', '{noop}manager1', null, null, 'off', 'manager1');
INSERT INTO MEMBER (ID, BRANCH_ID, CREATED, CREATOR, ENABLED, FIRST_MESSAGE, MANAGED, MAX_COUNSEL, MODIFIED, MODIFIER, NICKNAME, PASSWORD, PROFILE, SETTING, STATUS, USERNAME)
VALUES (4, 1, SYSDATE, 1, 'Y', null, 'Y', 50, SYSDATE, 1, '상담원1', '{noop}member1', null, null, 'on', 'member1');
INSERT INTO MEMBER (ID, BRANCH_ID, CREATED, CREATOR, ENABLED, FIRST_MESSAGE, MANAGED, MAX_COUNSEL, MODIFIED, MODIFIER, NICKNAME, PASSWORD, PROFILE, SETTING, STATUS, USERNAME)
VALUES (5, 1, SYSDATE, 1, 'Y', null, 'Y', 50, SYSDATE, 1, '상담원2', '{noop}member2', null, null, 'on', 'member2');
...
VALUES (1, SYSDATE, 1, 1, 3, 1);

-- ////////////////////////////////////////////////////////////////////////////
-- 상담 그룹 - 유저 매칭 (Static)
-- ////////////////////////////////////////////////////////////////////////////
INSERT INTO TEAM_MEMBER (ID, MEMBER_ID, MODIFIED, MODIFIER, TEAM_ID)
VALUES (1, 3, SYSDATE, 1, 1);
INSERT INTO TEAM_MEMBER (ID, MEMBER_ID, MODIFIED, MODIFIER, TEAM_ID)
VALUES (2, 4, SYSDATE, 1, 1);
INSERT INTO TEAM_MEMBER (ID, MEMBER_ID, MODIFIED, MODIFIER, TEAM_ID)
VALUES (3, 5, SYSDATE, 1, 1);
...
VALUES (1, SYSDATE, 1, '상담원', 'OPERATOR_1', 1);
INSERT INTO ROLES (ID, MODIFIED, MODIFIER, NAME, TYPE, LEVEL_ID)
VALUES (2, SYSDATE, 1, '매니저', 'MANAGER_1', 2);
INSERT INTO ROLES (ID, MODIFIED, MODIFIER, NAME, TYPE, LEVEL_ID)
VALUES (3, SYSDATE, 1, '관리자', 'ADMIN_1', 3);
INSERT INTO ROLES (ID, MODIFIED, MODIFIER, NAME, TYPE, LEVEL_ID)
VALUES (4, SYSDATE, 1, '마스터', 'MASTER_1', 4);

-- ////////////////////////////////////////////////////////////////////////////
-- 브랜치 - 역할 매칭 (Static)
-- ////////////////////////////////////////////////////////////////////////////
INSERT INTO BRANCH_ROLE (ID, BRANCH_ID, MODIFIED, MODIFIER, ROLE_ID)
VALUES (1, 1, SYSDATE, 1, 1);
INSERT INTO BRANCH_ROLE (ID, BRANCH_ID, MODIFIED, MODIFIER, ROLE_ID)
VALUES (2, 1, SYSDATE, 1, 2);
INSERT INTO BRANCH_ROLE (ID, BRANCH_ID, MODIFIED, MODIFIER, ROLE_ID)
VALUES (3, 1, SYSDATE, 1, 3);

-- ////////////////////////////////////////////////////////////////////////////
-- 유저 - 역할 매칭 (Static)
-- ////////////////////////////////////////////////////////////////////////////
INSERT INTO MEMBER_ROLE (ID, MEMBER_ID, MODIFIED, MODIFIER, ROLE_ID)
VALUES (1, 1, SYSDATE, 1, 4);
INSERT INTO MEMBER_ROLE (ID, MEMBER_ID, MODIFIED, MODIFIER, ROLE_ID)
VALUES (2, 2, SYSDATE, 1, 3);
INSERT INTO MEMBER_ROLE (ID, MEMBER_ID, MODIFIED, MODIFIER, ROLE_ID)
VALUES (3, 3, SYSDATE, 1, 2);
INSERT INTO MEMBER_ROLE (ID, MEMBER_ID, MODIFIED, MODIFIER, ROLE_ID)
VALUES (4, 4, SYSDATE, 1, 1);
INSERT INTO MEMBER_ROLE (ID, MEMBER_ID, MODIFIED, MODIFIER, ROLE_ID)
VALUES (5, 5, SYSDATE, 1, 1);
...
}', 0, 'category', 'Y', SYSDATE, 1, 'N', 1, 1, 1);

-- ////////////////////////////////////////////////////////////////////////////
-- 분류 (Static)
-- ////////////////////////////////////////////////////////////////////////////
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (1, 1, 1, 'Y', 'Y', SYSDATE, 1, '대분류1', 1, null);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (2, 1, 1, 'Y', 'Y', SYSDATE, 1, '대분류2', 2, null);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (3, 1, 1, 'Y', 'Y', SYSDATE, 1, '대분류3', 3, null);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (4, 1, 2, 'Y', 'Y', SYSDATE, 1, '중분류11', 1, 1);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (5, 1, 2, 'Y', 'Y', SYSDATE, 1, '중분류12', 2, 1);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (6, 1, 2, 'Y', 'Y', SYSDATE, 1, '중분류13', 3, 1);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (7, 1, 2, 'Y', 'Y', SYSDATE, 1, '중분류21', 1, 2);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (8, 1, 2, 'Y', 'Y', SYSDATE, 1, '중분류22', 2, 2);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (9, 1, 2, 'Y', 'Y', SYSDATE, 1, '중분류23', 3, 2);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (10, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류221', 1, 8);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (11, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류222', 2, 8);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (12, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류231', 3, 9);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (13, 1, 2, 'Y', 'Y', SYSDATE, 1, '중분류31', 1, 3);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (14, 1, 2, 'Y', 'Y', SYSDATE, 1, '중분류32', 2, 3);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (31, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류312', 1, 13);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (32, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류321', 2, 14);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (33, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류322', 1, 14);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (34, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류323', 2, 14);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (21, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류211', 1, 7);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (22, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류212', 2, 7);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (23, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류232', 1, 9);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (24, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류311', 2, 13);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (35, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류111', 3, 4);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (36, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류112', 3, 4);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (37, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류121', 3, 5);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (38, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류122', 3, 5);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (39, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류131', 3, 6);
INSERT INTO ISSUE_CATEGORY (ID, CHANNEL_ID, DEPTH, ENABLED, EXPOSED, MODIFIED, MODIFIER, NAME, SORT, PARENT_ID)
VALUES (40, 1, 3, 'Y', 'Y', SYSDATE, 1, '소분류132', 3, 6);
...
VALUES (1, 1, 100, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (2, 1, 110, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (3, 1, 120, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (4, 1, 121, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (5, 1, 122, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (6, 1, 123, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (7, 1, 130, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (8, 1, 131, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (9, 1, 132, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (10, 1, 133, 1, SYSDATE);
-- 매니저
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (21, 2, 100, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (22, 2, 110, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (23, 2, 120, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (24, 2, 121, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (25, 2, 122, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (26, 2, 123, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (27, 2, 130, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (28, 2, 131, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (29, 2, 132, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (30, 2, 133, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (41, 2, 200, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (42, 2, 210, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (43, 2, 211, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (44, 2, 220, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (45, 2, 221, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (46, 2, 222, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (47, 2, 230, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (48, 2, 231, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (49, 2, 232, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (50, 2, 233, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (51, 2, 234, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (52, 2, 235, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (53, 2, 240, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (54, 2, 241, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (55, 2, 242, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (56, 2, 245, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (57, 2, 246, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (58, 2, 247, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (59, 2, 250, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (60, 2, 251, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (61, 2, 260, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (62, 2, 261, 1, SYSDATE);
-- 관리자
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (101, 3, 300, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (102, 3, 310, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (105, 3, 314, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (106, 3, 320, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (107, 3, 321, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (108, 3, 322, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (109, 3, 323, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (110, 3, 325, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (111, 3, 390, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (112, 3, 391, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (113, 3, 200, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (114, 3, 210, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (115, 3, 211, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (116, 3, 220, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (117, 3, 221, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (118, 3, 222, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (119, 3, 230, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (120, 3, 231, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (121, 3, 232, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (122, 3, 233, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (123, 3, 234, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (124, 3, 235, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (125, 3, 240, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (126, 3, 241, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (127, 3, 242, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (128, 3, 245, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (129, 3, 246, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (130, 3, 247, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (131, 3, 250, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (132, 3, 251, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (133, 3, 260, 1, SYSDATE);
INSERT INTO ROLE_MENU (ID, ROLE_ID, MENU_ID, MODIFIER, MODIFIED)
VALUES (134, 3, 261, 1, SYSDATE);
...
VALUES (1, SYSDATE, 1, 1, 100);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (2, SYSDATE, 1, 1, 110);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (3, SYSDATE, 1, 1, 120);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (4, SYSDATE, 1, 1, 121);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (5, SYSDATE, 1, 1, 122);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (6, SYSDATE, 1, 1, 123);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (7, SYSDATE, 1, 1, 124);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (8, SYSDATE, 1, 1, 130);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (9, SYSDATE, 1, 1, 131);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (10, SYSDATE, 1, 1, 132);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (11, SYSDATE, 1, 1, 133);

-- 매니저
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (20, SYSDATE, 1, 2, 100);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (21, SYSDATE, 1, 2, 110);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (22, SYSDATE, 1, 2, 120);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (23, SYSDATE, 1, 2, 121);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (24, SYSDATE, 1, 2, 122);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (25, SYSDATE, 1, 2, 123);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (26, SYSDATE, 1, 2, 124);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (27, SYSDATE, 1, 2, 130);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (28, SYSDATE, 1, 2, 131);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (29, SYSDATE, 1, 2, 132);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (30, SYSDATE, 1, 2, 133);

INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (31, SYSDATE, 1, 2, 200);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (32, SYSDATE, 1, 2, 211);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (33, SYSDATE, 1, 2, 221);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (34, SYSDATE, 1, 2, 222);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (35, SYSDATE, 1, 2, 231);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (36, SYSDATE, 1, 2, 232);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (37, SYSDATE, 1, 2, 233);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (38, SYSDATE, 1, 2, 234);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (39, SYSDATE, 1, 2, 235);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (40, SYSDATE, 1, 2, 241);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (41, SYSDATE, 1, 2, 242);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (42, SYSDATE, 1, 2, 243);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (43, SYSDATE, 1, 2, 245);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (44, SYSDATE, 1, 2, 246);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (45, SYSDATE, 1, 2, 247);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (46, SYSDATE, 1, 2, 251);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (47, SYSDATE, 1, 2, 261);

-- 관리자
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (50, SYSDATE, 1, 3, 200);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (51, SYSDATE, 1, 3, 211);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (52, SYSDATE, 1, 3, 221);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (53, SYSDATE, 1, 3, 222);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (54, SYSDATE, 1, 3, 231);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (55, SYSDATE, 1, 3, 232);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (56, SYSDATE, 1, 3, 233);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (57, SYSDATE, 1, 3, 234);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (58, SYSDATE, 1, 3, 235);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (59, SYSDATE, 1, 3, 241);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (60, SYSDATE, 1, 3, 242);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (61, SYSDATE, 1, 3, 243);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (62, SYSDATE, 1, 3, 245);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (63, SYSDATE, 1, 3, 246);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (64, SYSDATE, 1, 3, 247);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (65, SYSDATE, 1, 3, 251);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (66, SYSDATE, 1, 3, 261);

INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (70, SYSDATE, 1, 3, 300);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (71, SYSDATE, 1, 3, 314);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (72, SYSDATE, 1, 3, 321);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (73, SYSDATE, 1, 3, 322);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (74, SYSDATE, 1, 3, 323);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (75, SYSDATE, 1, 3, 325);
INSERT INTO ROLE_PRIVILEGE (ID, CREATED, CREATOR, ROLE_ID, PRIVILEGE_ID)
VALUES (76, SYSDATE, 1, 3, 391);
