...
//		WebAuthenticationDetails web = (WebAuthenticationDetails) authentication.getDetails();
		...
		authMember.setClientIp(request.getHeader("X-Forwarded-For") != null ? request.getHeader("X-Forwarded-For") : request.getRemoteAddr());
		authMember.setUserAgent(request.getHeader("user-agent"));
