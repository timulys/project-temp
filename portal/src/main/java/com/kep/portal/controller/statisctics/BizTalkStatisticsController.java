...
public class BizTalkStatisticsController {
    ...
    public ResponseEntity<ApiResult<BizTalkHistoryStatisticsDto>> history(@RequestParam(name = "from") @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate from
    ...
    public ResponseEntity<ApiResult<BizTalkHistoryStatisticsDto>> historySum(@RequestParam(name = "from") @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate from
            , @RequestParam(name = "to") @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate to
            , @RequestParam(name = "branch_id",required = false) Long branchId
            , @RequestParam(name = "team_id",required = false) Long teamId
            , @RequestParam(name = "member_id",required = false) Long memberId
